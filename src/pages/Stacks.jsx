    ...
    <div className="h-screen max-w-screen">
      ...
      <div className="flex justify-around">
        <Link to='/projects/Docker'>
          <div className="flex-col flex items-center">
            <img src={docker} alt="docker" className="w-56"/>
            <p>Docker</p>
          </div>
        </Link>
        <Link to='/projects/Kotlin'>
          <div className="flex-col flex items-center">
            <img src={kotlin} alt="kotlin" className="w-56"/>
            <p>Kotlin</p>
          </div>
        </Link>
        <Link to='/projects/Python'>
          <div className="flex-col flex items-center">
            <img src={python} alt="python" className="w-56"/>
            <p>Python</p>
          </div>
        </Link>
      ...
      <div className="flex justify-between w-8/12 ml-56 mt-4">
        <Link to='/projects/Typescript'>
          <div className="flex-col flex items-center">
            <img src={typescript} alt="typescript" className="w-56"/>
            <p>Typescript</p>
          </div>
        </Link>
        <Link to='/projects/MySQL'>
          <div className="flex-col flex items-center">
            <img src={mysql} alt="mysql" className="w-56"/>
            <p>MySql</p>
          </div>
        </Link>
        <Link to='/projects/Laravel'>
          <div className="flex-col flex items-center">
            <img src={laravel} alt="laravel" className="w-56"/>
            <p>Laravel</p>
          </div>
        </Link>
      </div>
